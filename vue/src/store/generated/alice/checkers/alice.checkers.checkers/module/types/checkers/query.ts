...
export const protobufPackage = 'captoshkala.checkers.checkers'
...
export class QueryClientImpl implements Query {
  ...
  CanPlayMove(request: QueryCanPlayMoveRequest): Promise<QueryCanPlayMoveResponse> {
    ...
    const promise = this.rpc.request('captoshkala.checkers.checkers.Query', 'CanPlayMove', data)
  ...
  StoredGame(request: QueryGetStoredGameRequest): Promise<QueryGetStoredGameResponse> {
    ...
    const promise = this.rpc.request('captoshkala.checkers.checkers.Query', 'StoredGame', data)
  ...
  StoredGameAll(request: QueryAllStoredGameRequest): Promise<QueryAllStoredGameResponse> {
    ...
    const promise = this.rpc.request('captoshkala.checkers.checkers.Query', 'StoredGameAll', data)
  ...
  NextGame(request: QueryGetNextGameRequest): Promise<QueryGetNextGameResponse> {
    ...
    const promise = this.rpc.request('captoshkala.checkers.checkers.Query', 'NextGame', data)
