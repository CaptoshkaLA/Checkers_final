...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/captoshkala/checkers/checkers/canPlayMove
   */
  queryCanPlayMove = (
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/captoshkala/checkers/checkers/canPlayMove`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/captoshkala/checkers/checkers/nextGame
   */
  queryNextGame = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetNextGameResponse, RpcStatus>({
      path: `/captoshkala/checkers/checkers/nextGame`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/captoshkala/checkers/checkers/storedGame
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/captoshkala/checkers/checkers/storedGame`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/captoshkala/checkers/checkers/storedGame/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/captoshkala/checkers/checkers/storedGame/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
