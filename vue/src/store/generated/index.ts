...
import AliceCheckersAliceCheckersCheckers from './captoshkala/checkers/captoshkala.checkers.checkers'
...
export default { 
  AliceCheckersAliceCheckersCheckers: load(AliceCheckersAliceCheckersCheckers, 'captoshkala.checkers.checkers'),
